...
const ecoKeywords = {
  ...
  food: [
    ...
    'herbal', 'raw', 'free-range', 'eco-friendly', 'nutritious', 'freshly grown'
  ],
  accessories: [
    ...
    'upcycled', 'solar gadgets', 'recycled', 'sustainable', 'plastic-free', 'conscious products', 'fairtrade', 'reusable', 'eco tech'
  ]
};
